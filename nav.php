...
else
{
	...
	//	}
		...
		print " <li><a href=\"./esagu.php\">esagu</a>
			<ul class='children'>
			<li><a href=\"./ \">Registration</a>
			</li></ul></li>";
		print " <li><a href=\"./ehorti.php\">ehorti</a></li>";
	...
	elseif (($farmer_active=='0') && ($cord_active=='0') && ($partner_active=='0'))
	{
		...
		print "	<li class='cat-item'><a href=\"partner_registration.php\">Partner</a></li> 
			<li class='cat-item'><a href=\"coordinator_registration.php\">coordinator</a></li> 
			<li class='cat-item'><a href=\"expert_registration.php\">Expert</a></li>
			<li class='cat-item'><a href=\"./#\">Guest</a></li>
                        </ul></li>";
	}
